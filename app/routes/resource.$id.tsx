...
export default function ResourceDetail() {
  ...
  // Find the resource across all blocks
  const resource = resourceBlocks
  ...
  // Use description2 if available, otherwise use description
  const detailedDescription = resource.description2 || resource.description;
